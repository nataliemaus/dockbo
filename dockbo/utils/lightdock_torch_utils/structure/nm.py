...
from dockbo.utils.lightdock_torch_utils.lightdock_errors import NormalModesCalculationError
...
def calculate_nmodes(pdb_file_name, n_modes, rmsd, seed, molecule):
    ...
    if calculated_n_modes < n_modes:
        # print(
        #     "WARNING: Number of non-trivial calculated modes is %d (asked for %d)"
