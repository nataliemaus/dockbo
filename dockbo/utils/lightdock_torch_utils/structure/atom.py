...
from dockbo.utils.lightdock_torch_utils.lightdock_errors import AtomError
import torch 
...
class Atom(object):
    ...
    def distance(self, other):
        self_coords = torch.tensor([self.x, self.y, self.z])
        other_coords = torch.tensor([other.x, other.y, other.z])
        dist = self.pdist(self_coords, other_coords).item() 
        return dist 
